...
void cUiCustomizingScene::SetupPlayer(void)
{
	...
	m_pPlayer->RegisterAnimation(cPlayer::ANIMATION_IDLE_LEFTHEAD, g_pAnimationManager->GetAnimation("여성_기본01") );
	//애니메이션 변형
	m_pPlayer->SetAnimation(cPlayer::ANIMATION_IDLE_LEFTHEAD);
}